...
compile: env
	...
	$(VENV_BIN)/pip-compile --allow-unsafe --generate-hashes --output-file requirements.base.txt requirements.base.in
	$(VENV_BIN)/pip-compile --allow-unsafe --generate-hashes --output-file requirements.dev.txt requirements.dev.in
	$(VENV_BIN)/pip-compile --allow-unsafe --generate-hashes --output-file requirements.ci.txt requirements.ci.in
