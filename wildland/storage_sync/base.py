...
class SyncConflict(SyncError):
    ...
    @staticmethod
    def fromJSON(s: str) -> 'SyncConflict':
        """
        Deserialize from JSON.
        """
        obj = json.loads(s)
        print(f'SyncConflict.fromJSON({s}) = {obj}')
        return SyncConflict(obj['path'], obj['backend1_id'], obj['backend2_id'])
...
class SyncConflictEvent(SyncEvent):
    ...
    def fromJSON(s: str) -> 'SyncConflictEvent':
        ...
        return SyncConflictEvent(SyncConflict.fromJSON(obj['value']))

    def __init__(self, conflict: SyncConflict):
        self.conflict = conflict
        self.value = str(self.conflict)
