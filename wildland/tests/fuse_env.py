...
class FuseEnv:
    ...
    def __init__(self):
        # Intentionally creating test dir in $HOME instead of /tmp due to sticky bit set on /tmp
        # which prevents from correctly dereferencing symlinks.
        # See: https://unix.stackexchange.com/a/355042/28115
        self.test_dir = Path(tempfile.mkdtemp(prefix='wlfuse.', suffix='.test', dir=Path.home()))
