...
def test_container_rename_file_in_same_directory(env, container):
    ...
    os.rename(env.mnt_dir / container / 'foo', env.mnt_dir / 'container1/bar')
...
def test_container_file_symlink(env, container):
    ...
    assert (env.mnt_dir / container / 'file_symlink').is_symlink()
...
def test_container_dir_symlink(env, container):
    ...
    assert (env.mnt_dir / container / 'dir_symlink').is_symlink()
