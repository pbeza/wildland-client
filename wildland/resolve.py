...
# TODO: this would be much easier if Storage commands were guaranteed to raise
...
def storage_write_file(data, storage, relpath):
    ...
    if exists:
        ...
        obj = storage.create(relpath, 0, 0)
