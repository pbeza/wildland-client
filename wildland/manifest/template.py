...
class TemplateFile:
    """
    Defines physical file that holds list of StorageTemplate-s in yaml format
    """
...
class TemplateManager:
    ...
    def get_file_path(self, name: str) -> Path:
        ...
        return Path(self.template_dir / file_name)
    ...
    def get_storage_file_by_name(self, template_name: str) -> TemplateFile:
        """
