...
:command:`wl storage create git --container <container> [-u] [--user <user>] --url <url> --clone-location <clone-location> [--username <username>] [--password <password>] [--no-publish] <storage>`
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
