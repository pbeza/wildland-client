...
:command:`wl template create git --url <url> --clone-location <clone-location> [--username <username>] [--password <password>] NAME`
------------------------------------------------------------------------------------------------------------------------------------
...
:command:`wl template add git --url <url> --clone-location <clone-location> [--username <username>] [--password <password>] NAME`
----------------------------------------------------------------------------------------------------------------------------------
