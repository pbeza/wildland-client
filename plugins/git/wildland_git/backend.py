...
class GitStorageBackend(DirectoryCachedStorageMixin, StorageBackend):
    ...
    SCHEMA = Schema({
        ...
        "properties": {
            ...
            "clone_location": {
                "type": ["string"],
                "description": "Location of the cloned copy of the repository"
                    },
            "username": {
                "type": ["string"],
    ...
    def __init__(self, **kwds):
        ...
        location = self.params['clone_location'] + f'/{self._directory_uuid()}'
    ...
    def cli_options(cls):
        ...
        opts.extend([
            ...
            click.Option(
                ['--clone-location'], required=True, default='/tmp/git_repo',
                help='Location of the cloned copy of the repository'
            ),
            click.Option(
    ...
    def cli_create(cls, data):
        ...
        result.update({
            'url': data['url'],
            'clone_location' : data['clone_location'],
