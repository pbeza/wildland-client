...
class GitlabStorageBackend(GeneratedStorageMixin, StorageBackend):
    ...
    def storage_options(cls) -> List[StorageParam]:
        return [
            StorageParam(
                'server_url', display_name='URL',
                default_value='https://gitlab.com/',
                description='GitLab server url'),
            StorageParam(
                'personal_token', required=True,
                description='personal access token generated by GitLab; used for authorization '
                            'purposes'),
            StorageParam(
                'projectid', required=False,
                description='(optional) GitLab project ID. Can be copied from the Project ID '
                            'field upon'
